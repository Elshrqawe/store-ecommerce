            ...
            <div class="topbar-menu-area">
                <div class="container">
                    <div class="topbar-menu left-menu">
                        <ul>
                            <li class="menu-item" >
                                <a title="Hotline:201016736771" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: 201016736771</a>
                            </li>
                        </ul>
                    </div>
                                ...
                                <div class="wrap-contact-detail">
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <p class="contact-txt">01016736771</p>
                                        </li>
                                        <li>
                                            <i class="fa fa-envelope" aria-hidden="true"></i>
                                            <p class="contact-txt">YOUSEF ELSHRQAWE.com</p>
                                        </li>
                                    </ul>
                                </div>
                            </div>
